//
//  UltraDustSettingViewController.swift
//  YeolDot
//
...
class UltrafineDustViewController: UITableViewController{
    //선택 테이블 셀 열 저장 변수
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        //초미세먼지 파라미터 토픽에 값 전송
        SubMQTT.client.publish("YeolDot/user/dev1/window/PM25Param", withString: settingTitles[indexPath.row], qos: .qos2, retained: true)
